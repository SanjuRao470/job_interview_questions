...
//      function Inner(){
//          var b=20;
//          console.log(a.values.c+b)//50//Reason:because a is no primitive(reference type) datatype here and already used now we can mutates because it still point the same memory
//      }
//    return Inner;
//  }
//  var varFn = OuterFun(a)
